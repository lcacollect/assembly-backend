...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('projectepd', sa.Column('kg_per_m2', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('source_data', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('penre_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('ep_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    ...
    op.add_column('projectepd', sa.Column('pere_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('ap_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('kg_per_m3', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    ...
    op.add_column('projectepd', sa.Column('odp_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('date_updated', sa.DATE(), autoincrement=False, nullable=False))
    op.add_column('projectepd', sa.Column('gwp_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('thickness', postgresql.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=True))
    op.add_column('projectepd', sa.Column('region', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('projectepd', sa.Column('pocp_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    ...
    op.add_column('epd', sa.Column('penre_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('epd', sa.Column('unit', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('epd', sa.Column('ep_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('epd', sa.Column('type', sa.VARCHAR(), autoincrement=False, nullable=False))
    op.add_column('epd', sa.Column('ap_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('epd', sa.Column('pere_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    ...
    op.add_column('epd', sa.Column('odp_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('epd', sa.Column('date_updated', sa.DATE(), autoincrement=False, nullable=False))
    op.add_column('epd', sa.Column('gwp_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
    op.add_column('epd', sa.Column('pocp_by_phases', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True))
